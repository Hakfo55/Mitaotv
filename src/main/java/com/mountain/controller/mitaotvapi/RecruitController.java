 ...
 */
@RestController
@RequestMapping("/mitaotv/recruit")
@Api(description = "招聘图片列表api")
public class RecruitController {
    @Autowired
    RecruitBusiness business;

    @GetMapping("/findbyid")
    @ApiOperation(value = "通过id查询单个招聘图片")
//    @IgnoreSecurity
...
//    @IgnoreSecurity
    ...
    @PostMapping("/insert")
    @ApiOperation(value = "新增招聘图片")
//    @IgnoreSecurity
    public ResultBean<Object> insert(@Valid Recruit recruit) throws ServiceException {
        return ResultBean.defaultSuccess(business.insertT(recruit));
    }

    @PutMapping("/update")
    @ApiOperation(value = "修改招聘图片")
//    @IgnoreSecurity
    public ResultBean<Object> update(@Valid Recruit recruit) {

        return ResultBean.defaultSuccess(business.update(recruit));
    }

    @DeleteMapping("/delete")
    @ApiOperation(value = "逻辑删除招聘图片")
//    @IgnoreSecurity
